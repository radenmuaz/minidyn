...
class World: 
    ...
    def __init__(self):
        ...
        self.gravity = jnp.array((0, 0, -9.81))
        self.init_qs = []
        self.init_qds = []
    ...
    def add_body(self, body):
        ...
        # self.init_qs += [jnp.zeros(7).at[0].set(1)]
        self.init_qs += [jnp.zeros(7).at[0].set(1).at[6].set(10)]
        self.init_qds += [jnp.zeros(7).at[0].set(1e-9)]
...
class Sim(object):
    ...
    def solve(self, world, qs, qds, u):
        ...
        def L(qs, qds, u, world):
            Ts, Vs = world.get_energies(qs, qds, u)
