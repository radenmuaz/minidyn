...
if __name__ == "__main__":
    ...
    box1_shape = trimesh.creation.box((10, 10, 0.2))
    box1_body.shapes = [mdn.dyn.body.Shape.from_trimesh(box1_shape)]
    world.add_body(box1_body, q=jnp.array([1., 0, 0, 0., 0, 0. , -1]))
    ...
    world.add_body(box2_body, q=jnp.array([1., 0, 0, 0., 0, 0. , 0.2]))

    a1, a2 = jnp.array([0.0, 0, 0 ]), jnp.array([0., 0,0 ])
    joint = mdn.dyn.FixedJoint()
    joint.connect(world, box1_body, box2_body, a1, a2)
